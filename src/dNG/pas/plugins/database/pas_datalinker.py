...
"""
dNG.pas.plugins.database.pas_datalinker
"""
"""n// NOTE
----------------------------------------------------------------------------
direct PAS
...
:since: v0.1.00
	...
	NamedLoader.get_instance("dNG.pas.database.instances.DataLinker")
	NamedLoader.get_instance("dNG.pas.database.instances.DataLinkerMeta")
